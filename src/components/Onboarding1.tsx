              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div className="w-64 md:w-80 lg:w-96 h-64 md:h-80 lg:h-96 border-4 md:border-5 lg:border-6 border-[#111111] rounded-full relative">
                  ...
                  <div className="absolute top-20 md:top-24 lg:top-28 left-1/2 transform -translate-x-1/2">
                    <div className="text-xs md:text-sm lg:text-base font-medium text-[#111111] bg-white px-2 md:px-3 lg:px-4 py-1 md:py-1.5 lg:py-2 rounded md:rounded-lg border shadow-sm">Words</div>
                  </div>
                  <div className="absolute bottom-20 md:bottom-24 lg:bottom-28 left-1/4">
                    <div className="text-xs md:text-sm lg:text-base font-medium text-[#111111] bg-[#FEFEFE] px-2 md:px-3 lg:px-4 py-1 md:py-1.5 lg:py-2 rounded md:rounded-lg border shadow-sm">Ideas</div>
                  </div>
                  <div className="absolute right-8 md:right-10 lg:right-12 top-1/2 transform -translate-y-1/2">
                    <div className="text-xs md:text-sm lg:text-base font-medium text-[#111111] bg-white px-2 md:px-3 lg:px-4 py-1 md:py-1.5 lg:py-2 rounded md:rounded-lg border shadow-sm">Language</div>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-4 md:-bottom-5 lg:-bottom-6 right-16 md:right-20 lg:right-24 w-3 md:w-4 lg:w-5 h-3 md:h-4 lg:h-5 bg-[#111111] rounded md:rounded-lg"></div>
          ...
          <div className="space-y-6 md:space-y-8 lg:space-y-10 mt-8 lg:mt-0 lg:flex-shrink-0 lg:max-w-md xl:max-w-lg">
            ...
            <div className="text-center lg:text-left space-y-3 md:space-y-4 lg:space-y-5">
              ...
              <p className="text-[15px] md:text-[17px] lg:text-[19px] xl:text-[21px] font-normal leading-[21px] md:leading-[25px] lg:leading-[28px] xl:leading-[31px] text-[rgba(17,17,17,0.8)] font-[Metropolis] px-4 lg:px-0 max-w-lg mx-auto lg:mx-0">
                Explore fresh word ideas every day and see how language evolves through the community.
              </p>
            </div>
