        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <div className="bg-white rounded-3xl border border-[#EFEFEF] p-6 mx-auto w-full max-w-md">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-[14px] font-normal leading-[14px] text-[#656565] font-[Metropolis] mb-4">
                Sign in with
              </p>
              
              {/* Demo Login Info */}
              <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-[12px] text-blue-800 font-medium mb-1 font-[Parkinsans]">Demo Login:</p>
                <p className="text-[12px] text-blue-600 font-[Metropolis]">
                  <strong>Email:</strong> demo@neolingo.com<br />
              ...
              <div className="flex items-center justify-between mt-4">
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-4 h-4 text-[#111111] border-[rgba(17,17,17,0.15)] rounded focus:ring-[#111111]"
                  />
                  <span className="text-[14px] text-[#656565] font-[Metropolis]">Remember Me</span>
                </label>
                <a 
                  href="/reset-password" 
                  className="text-[14px] text-[#656565] hover:text-[#111111] transition-colors font-[Metropolis]"
                >
                  Forget Password?
                </a>
              </div>
