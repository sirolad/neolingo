    ...
    setSuggestions(prev => 
      prev.map(suggestion => 
        suggestion.id === suggestionId 
          ? { 
              ...suggestion, 
              votes: suggestion.userHasVoted ? suggestion.votes - 1 : suggestion.votes + 1,
    ...
    <Layout variant="home">
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between py-4 md:py-6 lg:py-8">
          ...
          <h1 className="text-lg md:text-xl lg:text-2xl font-semibold text-neutral-950">Vote</h1>
          <button 
        ...
        <div className="flex-1 space-y-6 md:space-y-8 lg:space-y-10 pb-20 md:pb-8">
                ...
                <div className="p-6 md:p-8">
                  ...
                  <div className="flex items-center justify-between mb-4 md:mb-6">
                    <div className="flex items-center gap-2 text-sm md:text-base text-neutral-600">
                      <span>Suggested by <strong className="text-neutral-800">{suggestion.submittedBy}</strong></span>
                      <span>•</span>
                  ...
                  <WordCard
                    ...
                    type="voting"
                    bgColor={suggestion.userHasVoted ? 'bg-blue-50' : 'bg-neutral-50'}
                    borderColor={suggestion.userHasVoted ? 'border-blue-200' : 'border-neutral-200'}
                  ...
                  {suggestion.context && (
                    <div className="bg-neutral-50 hover:bg-neutral-100 transition-colors rounded-xl md:rounded-2xl p-4 md:p-5 lg:p-6">
                      <h4 className="text-sm md:text-base font-medium text-neutral-800 mb-2 md:mb-3">Usage Example:</h4>
                      <p className="text-sm md:text-base text-neutral-600 italic leading-relaxed">&quot;{suggestion.context}&quot;</p>
                    </div>
                  )}
                </div>
              </motion.div>
          ...
          {suggestions.length === 0 && (
            ...
            >
              ...
              <h3 className="text-lg md:text-xl lg:text-2xl font-medium text-neutral-800 mb-2 md:mb-3 lg:mb-4">No Suggestions Yet</h3>
